...
public class GestorModerador {
    ...
    public static String registrarModerador(String nombreCompleto, String identificacion, LocalDate fechaNacimiento, String contrasena, String correoElectronico) throws SQLException, IOException, ClassNotFoundException {
